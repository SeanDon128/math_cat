...
func _ready() -> void:
    ...
    for campaign in GameManager.AdventureCatalog.CAMPAIGNS:
        ...
        check(material.get_shader_parameter("grade") == 12.0 and material.get_shader_parameter("stage") == 3.0 and material.get_shader_parameter("shooting_star_intensity") == 0.65, "Boss keeps the exact Grade 12 palette and atmosphere")
